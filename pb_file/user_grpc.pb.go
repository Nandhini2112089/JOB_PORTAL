...
type UserserviceClient interface {
	...
	ListUser(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListResponse, error)
...
func (c *userserviceClient) ListUser(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserserviceServer interface {
	...
	ListUser(context.Context, *Empty) (*ListResponse, error)
...
func (UnimplementedUserserviceServer) ListUser(context.Context, *Empty) (*ListResponse, error) {
