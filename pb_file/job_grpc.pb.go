...
const (
	...
	JobService_CreateJobs_FullMethodName = "/JobService/CreateJobs"
...
type JobServiceClient interface {
	...
	CreateJobs(ctx context.Context, in *BatchJobRequest, opts ...grpc.CallOption) (*BatchJobResponse, error)
...
func (c *jobServiceClient) CreateJobs(ctx context.Context, in *BatchJobRequest, opts ...grpc.CallOption) (*BatchJobResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchJobResponse)
	err := c.cc.Invoke(ctx, JobService_CreateJobs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type JobServiceServer interface {
	...
	CreateJobs(context.Context, *BatchJobRequest) (*BatchJobResponse, error)
...
func (UnimplementedJobServiceServer) CreateJobs(context.Context, *BatchJobRequest) (*BatchJobResponse, error) {
...
func _JobService_CreateJobs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchJobRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(JobServiceServer).CreateJobs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: JobService_CreateJobs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JobServiceServer).CreateJobs(ctx, req.(*BatchJobRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var JobService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _JobService_CreateJobs_Handler,
		},
		{
			MethodName: "GetJob",
